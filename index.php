            ...
            <nav class="navbar navbar-default navigation-clean-search">
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navcol-1">
                        ...
                        <p class="navbar-text navbar-right"><a class="navbar-link login" href="login.php">Log In</a> <a class="btn btn-default action-button" role="button" href="#">Sign Up</a></p>
                    </div>
                </div>
            </nav>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-md-push-6 item text">
                        <h3>tWOWter </h3>
                        <p>A social media site where all of WOW lovers can get together and talk about WOW.</p>
                    </div>
